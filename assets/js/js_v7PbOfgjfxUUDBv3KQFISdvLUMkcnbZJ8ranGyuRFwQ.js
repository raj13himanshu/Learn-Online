!function(e, t) {
    ...
    function d(e, t) {
        ...
        K.support.html5Clone && e.innerHTML && !K.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Ye.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
    ...
    function k(e, n, r, i, o, a) {
        ...
        a = a || {},
        a[o] = !0;
        for (var s, l = e[o], u = 0, c = l ? l.length : 0, f = e === qt; u < c && (f || !s); u++)
    ...
    function F(e, t, n) {
        var r, i = 0, o = Gt.length, a = K.Deferred().always(function() {
            ...
            for (var t = Ut || L(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), i = 0, o = l.tweens.length; i < o; i++)
                l.tweens[i].run(r);
    ...
    var P, R, W = e.document, $ = e.location, I = e.navigator, z = e.jQuery, X = e.$, U = Array.prototype.push, Q = Array.prototype.slice, J = Array.prototype.indexOf, Y = Object.prototype.toString, V = Object.prototype.hasOwnProperty, G = String.prototype.trim, K = function(e, t) {
    ...
    K.extend({
        ...
        ready: function(e) {
            if (!0 === e ? !--K.readyWait : !K.isReady) {
                ...
                K.isReady = !0,
                !0 !== e && --K.readyWait > 0 || (R.resolveWith(W, [K]),
        ...
        type: function(e) {
            return null == e ? String(e) : de[Y.call(e)] || "object"
        },
        ...
        proxy: function(e, n) {
            ...
            n = e,
            e = r),
            K.isFunction(e) ? (i = Q.call(arguments, 2),
            o = function() {
    ...
    K.extend({
        ...
        when: function(e) {
            var t, n, r, i = 0, o = Q.call(arguments), a = o.length, s = 1 !== a || e && K.isFunction(e.promise) ? a : 0, l = 1 === s ? e : K.Deferred(), u = function(e, n, r) {
                return function(i) {
                    n[e] = this,
    ...
    K.fn.extend({
        ...
        val: function(e) {
            var n, r, i, o = this[0];
            return arguments.length ? (i = K.isFunction(e),
            ...
            "string" == typeof r ? r.replace(we, "") : null == r ? "" : r)) : void 0
        }
    }),
    K.extend({
        valHooks: {
        ...
        attr: function(e, n, r, i) {
            ...
            if (e && 3 !== l && 8 !== l && 2 !== l)
                return i && K.isFunction(K.fn[n]) ? K(e)[n](r) : void 0 === e.getAttribute ? K.prop(e, n, r) : ((s = 1 !== l || !K.isXMLDoc(e)) && (n = n.toLowerCase(),
    ...
    K.event = {
        ...
        trigger: function(n, r, i, o) {
            if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                ...
                for (l = 0; l < h.length && !n.isPropagationStopped(); l++)
                    ...
                    d && d.apply(u, r),
                    (d = f && u[f]) && K.acceptData(u) && d.apply && !1 === d.apply(u, r) && n.preventDefault();
                return n.type = m,
        ...
        dispatch: function(n) {
            ...
            var r, i, o, a, s, l, u, c, f, p = (K._data(this, "events") || {})[n.type] || [], d = p.delegateCount, h = Q.call(arguments), g = !n.exclusive && !n.namespace, m = K.event.special[n.type] || {}, y = [];
            if (h[0] = n,
            ...
            !m.preDispatch || !1 !== m.preDispatch.call(this, n)) {
                ...
                r = 0; r < y.length && !n.isPropagationStopped(); r++)
                    ...
                    i = 0; i < l.matches.length && !n.isImmediatePropagationStopped(); i++)
                        ...
                        n.handleObj = c,
                        (a = ((K.event.special[c.origType] || {}).handle || c.handler).apply(l.elem, h)) !== t && (n.result = a,
    ...
    K.each({
        ...
        K.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return o.selector,
                i && (i === r || K.contains(r, i)) || (e.type = o.origType,
    ...
    K.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function(e, t) {
        ...
        ,
        Ae.test(t) && (K.event.fixHooks[t] = K.event.keyHooks),
    ...
    function(e, t) {
        function n(e, t, n, r) {
            ...
            if (!(a = w(t)) && !r && (i = te.exec(e)))
                if (s = i[1]) {
                    ...
                    if (i[2])
                        return q.apply(n, _.call(t.getElementsByTagName(e), 0)),
                        n;
                    if ((s = i[3]) && fe && t.getElementsByClassName)
                        return q.apply(n, _.call(t.getElementsByClassName(s), 0)),
                        n
                }
        ...
        function s(e, t) {
            ...
            l = [],
            u = b.preFilter; s; ) {
                r && !(i = G.exec(s)) || (i && (s = s.slice(i[0].length)),
                l.push(o = [])),
                r = !1,
                (i = Z.exec(s)) && (o.push(r = new A(i.shift())),
                s = s.slice(r.length),
                r.type = i[0].replace(V, " "));
                for (a in b.filter)
                    (i = ae[a].exec(s)) && (!u[a] || (i = u[a](i, L, !0))) && (o.push(r = new A(i.shift())),
                    s = s.slice(r.length),
                    r.type = a,
                    r.matches = i);
                if (!r)
                ...
                if (n = b.relative[e[s].type])
                    ...
                    n[j]) {
                        for (r = ++s; r < i && !b.relative[e[r].type]; r++)
                            ;
                        return f(s > 1 && u(h), s > 1 && e.slice(0, s - 1).join("").replace(V, "$1"), n, s < r && p(e.slice(s, r)), r < i && p(e = e.slice(r)), r < i && e.join(""))
                    }
                    h.push(n)
                }
            return u(h)
        ...
        function g(e, t, n, r, i) {
            ...
            !r && 1 === f.length) {
                ...
                a.length > 2 && "ID" === (l = a[0]).type && 9 === t.nodeType && !i && b.relative[a[1].type]) {
                    if (!(t = b.find.ID(l.matches[0].replace(oe, ""), t, i)[0]))
                        return n;
                    e = e.slice(a.shift().length)
                }
                for (o = ae.POS.test(e) ? -1 : a.length - 1; o >= 0 && (l = a[o],
                !b.relative[u = l.type]); o--)
                    if ((c = b.find[u]) && (r = c(l.matches[0].replace(oe, ""), ne.test(a[0].type) && t.parentNode || t, i))) {
                        if (a.splice(o, 1),
                        !(e = r.length && a.join("")))
                            return q.apply(n, _.call(r, 0)),
                            n;
                        break
                    }
            }
            return N(e, f)(r, t, i, n, ne.test(e)),
            n
        }
        function m() {}
        var y, v, b, x, w, T, N, C, k, E, S = !0, D = "undefined", j = ("sizcache" + Math.random()).replace(".", ""), A = String, L = e.document, H = L.documentElement, F = 0, M = 0, O = [].pop, q = [].push, _ = [].slice, B = [].indexOf || function(e) {
        ...
        , P = function(e, t) {
        ...
        }, W = R(), $ = R(), I = R(), z = "[\\x20\\t\\r\\n\\f]", X = "(?:\\\\.|[-\\w]|[^\\x00-\\xa0])+", U = X.replace("w", "w#"), Q = "\\[" + z + "*(" + X + ")" + z + "*(?:([*^$|!~]?=)" + z + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + U + ")|)|)" + z + "*\\]", J = ":(" + X + ")(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:" + Q + ")|[^:]|\\\\.)*|.*))\\)|)", Y = ":(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + z + "*((?:-\\d)?\\d*)" + z + "*\\)|)(?=[^-]|$)", V = new RegExp("^" + z + "+|((?:^|[^\\\\])(?:\\\\.)*)" + z + "+$","g"), G = new RegExp("^" + z + "*," + z + "*"), Z = new RegExp("^" + z + "*([\\x20\\t\\r\\n\\f>+~])" + z + "*"), ee = new RegExp(J), te = /^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/, ne = /[\x20\t\r\n\f]*[+~]/, re = /h\d/i, ie = /input|select|textarea|button/i, oe = /\\(?!\\)/g, ae = {
            ID: new RegExp("^#(" + X + ")"),
            CLASS: new RegExp("^\\.(" + X + ")"),
            ...
            e.firstChild && typeof e.firstChild.getAttribute !== D && "#" === e.firstChild.getAttribute("href")
        }), ce = se(function(e) {
        ...
        n.attr = function(e, t) {
            ...
            (n = b.attrHandle[t]) ? n(e) : r || ce ? e.getAttribute(t) : (n = e.getAttributeNode(t),
        ...
        b = n.selectors = {
            ...
            find: {
                ...
                : function(e, t, n) {
                    if (typeof t.getElementById !== D && !n) {
                        var r = t.getElementById(e);
                        return r ? r.id === e || typeof r.getAttributeNode !== D && r.getAttributeNode("id").value === e ? [r] : void 0 : []
                    }
                }
                ,
                TAG: le ? function(e, t) {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n;
                    return ae.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[3] : (t = e[4]) && (ee.test(t) && (n = s(t, !0)) && (n = t.indexOf(")", t.length - n) - t.length) && (t = t.slice(0, n),
                    e[0] = e[0].slice(0, n)),
                    e[2] = t),
                    e.slice(0, 3))
                }
            ...
            filter: {
                ...
                PSEUDO: function(e, t) {
                    ...
                    b.setFilters.hasOwnProperty(e.toLowerCase()) ? P(function(e, n) {
    ...
    K.each({
        ...
        K.fn[e] = function(n, r) {
            ...
            this.pushStack(i, e, Q.call(arguments).join(","))
        }
    }),
    K.extend({
    ...
    K.fn.extend({
        ...
        html: function(e) {
            return K.access(this, function(e) {
                ...
                if ("string" == typeof e && !Ue.test(e) && (K.support.htmlSerialize || !Je.test(e)) && (K.support.leadingWhitespace || !We.test(e)) && !Ze[(Ie.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace($e, "<$1></$2>");
                    try {
                        for (; r < i; r++)
                            n = this[r] || {},
        ...
        domManip: function(e, n, r) {
            ...
            if (!K.support.checkClone && p > 1 && "string" == typeof u && Ve.test(u))
                return this.each(function() {
    ...
    K.buildFragment = function(e, n, r) {
        ...
        n = !n.nodeType && n[0] || n,
        n = n.ownerDocument || n,
        1 === e.length && "string" == typeof s && s.length < 512 && n === W && "<" === s.charAt(0) && !Qe.test(s) && (K.support.checkClone || !Ve.test(s)) && (K.support.html5Clone || !Je.test(s)) && (o = !0,
        i = K.fragments[s],
        a = i !== t),
    ...
    K.extend({
        ...
        clean: function(e, t, n, r) {
            var i, o, a, s, l, u, f, p, d, h, m, y = t === W && et, v = [];
    ...
    K.extend({
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if ("string" == (a = typeof r) && (o = pt.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(K.css(e, n)),
                a = "number"),
    ...
    ;
    var Ct, kt, Et = /#.*$/, St = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Dt = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, jt = /^(?:GET|HEAD)$/, At = /^\/\//, Lt = /\?/, Ht = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, Ft = /([?&])_=[^&]*/, Mt = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Ot = K.fn.load, qt = {}, _t = {}, Bt = ["*/"] + ["*"];
    try {
        kt = $.href
    } catch (e) {
    ...
    K.extend({
        ...
        ajax: function(e, n) {
            ...
            ,
            p.url = ((e || p.url) + "").replace(Et, "").replace(At, Ct[1] + "//"),
    ...
    K.ajaxPrefilter("json jsonp", function(n, r, i) {
        var o, a, s, l = n.data, u = n.url, c = !1 !== n.jsonp, f = c && Wt.test(u), p = c && !f && "string" == typeof l && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Wt.test(l);
        if ("jsonp" === n.dataTypes[0] || f || p)
            return o = n.jsonpCallback = K.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback,
            a = e[o],
            f ? n.url = u.replace(Wt, "$1" + o) : p ? n.data = l.replace(Wt, "$1" + o) : c && (n.url += (Rt.test(u) ? "&" : "?") + n.jsonp + "=" + o),
        ...
        if (!n.crossDomain || K.support.cors) {
            ...
            return {
                send: function(i, o) {
                        ...
                        try {
                            if (r && (i || 4 === l.readyState))
                                ...
                                i)
                                    ...
                                    f = {},
                                    (p = l.responseXML) && p.documentElement && (f.xml = p);
                                    try {
                    ...
                    ,
                    n.async ? 4 === l.readyState ? setTimeout(r, 0) : (a = ++Xt,
                    zt && (It || (It = {},
                    K(e).unload(zt)),
                    It[a] = r),
    ...
    var Ut, Qt, Jt = /^(?:toggle|show|hide)$/, Yt = new RegExp("^(?:([-+])=|)(" + Z + ")([a-z%]*)$","i"), Vt = /queueHooks$/, Gt = [O], Kt = {
        "*": [function(e, t) {
            var n, r, i = this.createTween(e, t), o = Yt.exec(t), a = i.cur(), s = +a || 0, l = 1, u = 20;
            if (o) {
                if (n = +o[2],
                "px" !== (r = o[3] || (K.cssNumber[e] ? "" : "px")) && s) {
    ...
    K.fx.timer = function(e) {
        e() && K.timers.push(e) && !Qt && (Qt = setInterval(K.fx.tick, K.fx.interval))
    }
    ,
    K.fx.interval = 13,
    K.fx.stop = function() {
    ...
    K.fn.offset = function(e) {
        ...
        return f ? (r = f.body) === c ? K.offset.bodyOffset(c) : (n = f.documentElement,
        K.contains(n, c) ? (void 0 !== c.getBoundingClientRect && (u = c.getBoundingClientRect()),
        i = B(f),
    ...
    K.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || W.body; e && !Zt.test(e.nodeName) && "static" === K.css(e, "position"); )
                    e = e.offsetParent;
                return e || W.body
            })
        }
...
function(e) {
    var t = e.fn.jquery.split(".")
      ...
      , i = parseInt(t[2])
      , o = i.toString() !== t[2];
    n > 3 || 3 === n && r > 4 || 3 === n && 4 === r && i > 0 || 3 === n && 4 === r && 0 === i && !o || (e.extend = e.fn.extend = function() {
        ...
        l--); l < u; l++)
            if (null != (t = arguments[l]))
                for (n in t)
                    i = t[n],
                    "__proto__" !== n && s !== i && (c && i && (e.isPlainObject(i) || (o = e.isArray(i))) ? (r = s[n],
                    a = o && !e.isArray(r) ? [] : o || e.isPlainObject(r) ? r : {},
                    o = !1,
                    s[n] = e.extend(c, a, i)) : void 0 !== i && (s[n] = i));
        return s
    }
    )
}(jQuery),
function(e) {
    var t = e.fn.jquery.split(".")
      ...
      , r = parseInt(t[1]);
    if (!(n > 3 || 3 === n && r >= 5)) {
        var i, o = ["a", "abbr", "address", "article", "aside", "audio", "b", "bdi", "bdo", "blockquote", "button", "canvas", "caption", "cite", "code", "data", "datalist", "dd", "del", "details", "dfn", "div", "dl", "dt", "em", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "i", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "menu", "meter", "nav", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "small", "source", "span", "strong", "sub", "summary", "sup", "table", "tbody", "td", "tfoot", "th", "thead", "time", "tr", "u", "ul", "var", "video"], a = "(" + o.join("|") + ")", s = new RegExp("<" + a + "\\/>","gi"), l = new RegExp("<" + a + "([\\x20\\t\\r\\n\\f][^>]*)\\/>","gi");
        i = n < 3 ? /<([\w:]+)/ : r < 4 ? /<([a-z][^\/\0>\x20\t\r\n\f]+)/i : /<([a-z][^\/\0>\x20\t\r\n\f]*)/i;
        var u = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi;
        if (e.extend({
            htmlPrefilter: function(e) {
                var t = (i.exec(e) || ["", ""])[1].toLowerCase();
                if ("option" !== t && "optgroup" !== t || !e.match(/<\/?select/i) || (e = ""),
                e = e.replace(s, "<$1></$1>"),
                e = e.replace(l, "<$1$2></$1>"),
                1 === n && r < 12 || 2 === n && r < 2) {
                    var o = e.replace(u, "<$1></$2>");
                    if (o !== e) {
                        var a = {
                            thead: [1, "<table>", "</table>"],
        ...
        1 === n && r < 12 || 2 === n && r < 2) {
            ...
            e.fn.extend({
                html: function(t) {
                    return "string" == typeof t && (t = e.htmlPrefilter(t)),
                    c.apply(this, arguments.length ? [t] : [])
                }
            });
            var f = /<|&#?\w+;/;
            if (1 === n && r < 9) {
                var p = e.clean;
                e.extend({
                    clean: function(t, n, r, i) {
                        for (var o, a = 0; null != (o = t[a]); a++)
                            "string" == typeof o && f.test(o) && (t[a] = o = e.htmlPrefilter(o));
                        return p.call(this, t, n, r, i)
                    }
                })
            } else {
                var d = e.buildFragment;
                e.extend({
                    buildFragment: function(t, n, r, i) {
                        for (var o = t.length, a = 0; a < o; a++) {
                            var s = t[a];
                            (s || 0 === s) && "object" !== e.type(s) && f.test(s) && (t[a] = s = e.htmlPrefilter(s))
                        }
                        return d.call(this, t, n, r, i)
                    }
                })
            }
        }
...
function(e) {
    ...
    ,
    e.fn.removeOnce = function(t, n) {
        var r = t + "-processed"
          , i = this.filter("." + r).removeClass(r);
        return e.isFunction(n) ? i.each(n) : i
    }
}(jQuery);
var Drupal = Drupal || {
    settings: {},
...
function(e) {
    ...
    ,
    e.fn.init.prototype = t.prototype,
    Drupal.attachBehaviors = function(t, n) {
        t = t || document,
        n = n || Drupal.settings,
        e.each(Drupal.behaviors, function() {
            e.isFunction(this.attach) && this.attach(t, n)
        })
    }
    ,
    Drupal.detachBehaviors = function(t, n, r) {
        t = t || document,
        n = n || Drupal.settings,
        r = r || "unload",
        e.each(Drupal.behaviors, function() {
            e.isFunction(this.detach) && this.detach(t, n, r)
        })
    }
    ,
    Drupal.checkPlain = function(e) {
        ...
        e = String(e);
        for (t in r)
            r.hasOwnProperty(t) && (n = new RegExp(t,"g"),
            e = e.replace(n, r[t]));
        return e
    }
    ,
    ...
    Drupal.t = function(e, t, n) {
        return n = n || {},
        n.context = n.context || "",
        Drupal.locale.strings && Drupal.locale.strings[n.context] && Drupal.locale.strings[n.context][e] && (e = Drupal.locale.strings[n.context][e]),
        t && (e = Drupal.formatString(e, t)),
        e
    }
    ,
    Drupal.formatPlural = function(e, t, n, r, i) {
        ...
        return 0 == o ? Drupal.t(t, r, i) : 1 == o ? Drupal.t(n, r, i) : (r["@count[" + o + "]"] = r["@count"],
        delete r["@count"],
        Drupal.t(n.replace("@count", "@count[" + o + "]"), r, i))
    }
    ,
    ...
    Drupal.freezeHeight = function() {
        ...
        e('<div id="freeze-height"></div>').css({
            position: "absolute",
            top: "0px",
            left: "0px",
            width: "1px",
            height: e("body").css("height")
        }).appendTo("body")
    }
    ,
    Drupal.unfreezeHeight = function() {
        e("#freeze-height").remove()
    }
    ,
    ...
    e(function() {
        if (void 0 === jQuery.support.positionFixed) {
            var t = e('<div style="position:fixed; top:10px" />').appendTo(document.body);
            jQuery.support.positionFixed = 10 === t[0].offsetTop,
            t.remove()
        }
    }),
    e(function() {
